...
export const Header = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className=" text-xl md:text-2xl text-xl font-bold">
        ...
        <nav
          className={`md:flex gap-6 items-center font-bold duration-500 py-[10px] md:py-[15px] ${
            open
              ? "md:hidden bg-sky-300 absolute top-0 left-0 translate-y-[50px] w-full flex justify-center flex-wrap gap-4"
              : "hidden"
          }`}
        >
          <Link
