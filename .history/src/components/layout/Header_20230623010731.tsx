  ...
  return (
    <>
      ...
      >
        ...
        <nav
          className={`md:flex gap-6 items-center font-bold duration-500  md:py-[15px] ${
            open
              ? "md:hidden bg-sky-300 absolute top-0 left-0 translate-y-[0px] w-full flex justify-center"
              : "hidden"
          }`}
        >
          <Link
