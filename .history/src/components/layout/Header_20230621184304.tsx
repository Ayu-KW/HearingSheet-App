...
export const Header = () => {
  ...
  return (
    <>
      ...
      <header className="bg-sky-600 text-white flex justify-around items-center fixed top-0 w-full shadow-md px-10">
        <h1 className="text-2xl font-bold">
          <Link href={"/"}>ヒアリングシートアプリ</Link>
        </h1>
        <nav
          className={`flex gap-6 items-center font-bold duration-300 py-[15px] ${
            open ? "bg-sky-300" : ""
          }`}
        >
          <Link
