...
export const Header = () => {
  ...
  return (
    <>
      ...
      <header className="bg-sky-600 text-white flex justify-between md:justify-around items-center fixed top-0 w-full shadow-md px-5">
        <h1 className="md:text-2xl text-xl  font-bold">
          <Link href={"/"}>ヒアリングシートアプリ</Link>
        </h1>
        <nav
          className={`hidden md:flex gap-6 items-center font-bold duration-300 py-[15px] ${
            open ? "bg-sky-300" : ""
          }`}
        >
          <Link
