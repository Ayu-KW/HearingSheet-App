      ...
      {fields.map((field: any, index: number) => (
        <React.Fragment key={index}>
          ...
          <div className="lg:grid grid-cols-3 w-full lg:w-[700px] p-2">
            <p className="w-fit whitespace-nowrap col-span-1 md:pt-8">{field.label}</p>
            {(() => {
              switch (field.type) {
                case "text":
                case "url":
                ...
                case "datetime-local":
                  return (
                    <div
                      className={`w-full col-span-2 before:content-[${field.description}] before:text-gray-400 lg:before:text-xs before: text-[10px]`}
                    >
                      {field.description && (
