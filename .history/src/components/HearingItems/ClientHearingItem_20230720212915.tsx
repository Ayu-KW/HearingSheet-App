      ...
      {HearingItem.map((item, index) => {
        const dtClassName =
          index === 0
            ...
            : item.title.startsWith("既存サイト：") // タイトルが「既存サイト：」で始まる場合にオレンジ色の背景にする
            ? "col-span-1 bg-cyan-8s00 text-white font-bold px-2 py-3 border-t border-t-gray-300 border-dashed"
