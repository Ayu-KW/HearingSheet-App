  ...
  return (
    <React.Fragment>
      {fields.map((field: any, index: number) => (
        <div key={index} className="grid grid-cols-3 w-[700px] p-2">
          <p className="w-fit whitespace-nowrap col-span-1 py-7">{field.label}</p>
          {(() => {
            switch (field.type) {
              case "text":
                return (
                  <div className="sw-full col-span-2 before:content-['${field.description}' before:text-gray-400 before:text-xs]">
