...
const CustomerCreation = () => {
  return (
    <main className="xl:w-2/3 lg:w-11/12 m-auto font-mono py-[100px] md:py-[150px] px-[30px]">
      ...
      <section className="p-5 m-auto border-sky-300 border shadow-lg shadow-slate-200 w-fit grid gap-y-1.5">
        <div className="flex justify-center items-center gap-4 w-[600px]">
          <p className="w-fit whitespace-nowrap">会社名</p>
          <input type="text" className="bg-gray-200 rounded-sm p-2 w-auto" />
        </div>
