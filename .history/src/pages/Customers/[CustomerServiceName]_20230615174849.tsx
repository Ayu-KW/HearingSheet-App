  ...
  return (
    <main className="lg:w-2/3 md:w-4/5 sm:w-11/12 m-auto font-mono py-36">
      ...
      <dl className="grid grid-cols-5">
        <dt className="col-span-1 bg-sky-500 text-white p-2 border border-blue-400">
          会社名
        </dt>
        <dd className="col-span-3 p-2 border border-blue-400">
          {clientPage.ClientComponyName}
        </dd>
        <dd className="col-span-1 p-2 border border-blue-400 flex">
