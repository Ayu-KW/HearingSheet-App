    ...
    <main className="lg:w-2/3 md:w-4/5 sm:w-11/12 m-auto font-mono py-36">
      ...
      <section className="m-auto mb-12 leading-loose">
        ...
        <div className="mt-2 px-3">
          ...
          <div className="p-2 border border-cyan-400">
            <h5 className="inline-block text-lg text-cyan-500 font-bold">《新規登録》</h5>
            <ul>
              <li className="">1.</li>
            </ul>
          </div>
          <div className="mt-1 p-2 border border-cyan-400">
            <h5 className="inline-block text-lg text-cyan-500 font-bold">《顧客一覧》</h5>
            <ul>
              <li className="">1.</li>
            </ul>
          </div>
