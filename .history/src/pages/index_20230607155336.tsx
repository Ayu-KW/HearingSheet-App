    ...
    <main className="lg:w-2/3 md:w-4/5 sm:w-11/12 m-auto font-mono py-36">
      ...
      <section className="border-t border-t-gray-400 pt-10">
        ...
        <dl className="grid grid-cols-2 gap-y-0.5">
          <dt className="bg-cyan-600 text-white font-bold p-2 w-[40%]">製作者</dt>
          <dd className="bg-gray-200 p-2">本文</dd>
          <dt className="bg-cyan-600 text-white font-bold p-2 w-[40%]">タイトル</dt>
          <dd className="p-2">本文</dd>
        </dl>
      </section>
    </main>
  );
