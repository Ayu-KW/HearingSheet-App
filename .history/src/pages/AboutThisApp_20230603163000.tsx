  ...
  return (
    <>
      ...
      <section className="m-auto my-8 lg:w-5/6">
        <h3 className="py-1 px-3 bg-cyan-100 border-cyan-500 border-y-2 border-solid text-xl">
          1.概要
        </h3>
        ...
        <table className="w-3/4 m-auto my-4 bg-white rounded-md ">
          <thead>
            <tr className="bg-blue-100 border-y border-y-blue-200">
              <th className="whitespace-nowrap w-1/3 p-2 border-x border-double border-x-slate-800">
                技術カテゴリ
              </th>
          ...
          <tbody>
            <tr>
              ...
              <td className="p-2 font-bold bg-rose-300">2</td>
            </tr>
          </tbody>
        </table>
      </section>
