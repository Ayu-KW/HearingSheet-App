  ...
  return (
    <main className="lg:w-2/3 md:w-4/5 sm:w-11/12 m-auto font-mono py-36">
      ...
      <table className="table-fixed w-auto m-auto border border-blue-400">
        <thead className="bg-cyan-600 text-white text-center">
          <tr className="border-b border-b-blue-400">
            <th className="border-r border-r-blue-400 p-2">No</th>
            <th className="border-r border-r-blue-400 p-2 w-1/2">会社名／サービス名</th>
        ...
        <tbody>
          <tr>
            ...
            <td className="border-r border-r-blue-400 p-2 text-center">
              <LinkButton
                style="bg-blue-600 hover:bg-blue-400 text-white py-1 px-2"
                url={"/CustomerDetail"}
              >
                詳細
              </LinkButton>
