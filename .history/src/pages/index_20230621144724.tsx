...
export default function Home() {
  return (
    <main className="lg:w-2/3 md:w-11/12 m-auto font-mono py-[150px] px-[30px]">
      ...
      <section className="mb-14">
        ...
        <div className="bg-slate-200 border-2 border-gray-400 border-dotted p-4 mb-14 leading-relaxed">
          ...
          <p>
            ...
            <Link
              href={"/AboutThisApp"}
              className=" inline-block text-sky-500 font-bold hover:text-orange-400 hover:duration-300"
            >
              「本アプリについて」
            </Link>
            のページをご覧ください。
