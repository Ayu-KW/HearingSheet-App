...
export default function Home() {
  return (
    <main className="lg:w-2/3 md:w-4/5 sm:w-11/12 m-auto font-mono py-36">
      ...
      <section className="bg-slate-200 border-2 border-gray-400 border-dotted p-4 mb-20 leading-loose">
        <h3 className="text-xl text-cyan-800 font-bold">本サイトの使い方など</h3>
        <p>
          本サイトの使い方については
          <Link href={"/AboutThisApp"} className=" inline-block text-cyan-600 font-bold">
            「本アプリについて」
          </Link>
          を
        </p>
      ...
      <section className="border-t border-t-gray-400 pt-10">
        <h3 className="text-2xl text-cyan-800 font-bold">問い合わせ</h3>
      </section>
    </main>
  );
}
