    ...
    <main className="lg:w-2/3 md:w-4/5 sm:w-11/12 m-auto font-mono py-36">
      ...
      <section className="border-t border-t-gray-300 pt-10">
        ...
        <dl className="grid grid-cols-3 gap-0.5">
          ...
          <dd className="bg-gray-200 p-2 col-span-2">Ayu Kawabata</dd>
          <dt className="bg-cyan-600 text-white font-bold p-2 col-span-1">タイトル</dt>
          <dd className="bg-gray-200 p-2 col-span-2">本文</dd>
        </dl>
      </section>
    </main>
  );
