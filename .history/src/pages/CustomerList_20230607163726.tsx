    ...
    <main className="lg:w-2/3 md:w-4/5 sm:w-11/12 m-auto font-mono py-36">
      <div className="text-center mb-10">
        ...
        <div className="text-left w-fit m-auto mt-4">
          ...
          <p>
            リスト内データの<span className="font-bold">「確認と編集」</span>
            はこちらから行えます。
          </p>
          <p>
            なおデータの
            <span className="font-bold">「削除については直接Notionデータベース」</span>
            から行ってください。
          </p>
        </div>
      </div>
        ...
        <tbody>
          <tr>
            ...
            <td className="border-r border-r-blue-400 p-2 text-center">
              <LinkButton
                style="bg-teal-600 hover:bg-sky-400 text-white py-1 px-2"
                url={"/CustomerDetail"}
              >
                詳細
              </LinkButton>
