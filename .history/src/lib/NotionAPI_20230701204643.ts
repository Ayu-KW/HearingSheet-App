...
type clientDataTest = {  properties: {
  CompanyName?: {
    title: Array<{ plain_text: string }>;
  };};

const getClientDataPropertiesTest = (clientDataTest) => {
  return {
    ClientComponyName: clientDataTest.properties?.CompanyName?.title[0]?.plain_text || "",
  };
};
